...
class _AiCameraScreenState extends State<AiCameraScreen> {
  ...
  Future<void> _handleCapture() async {
    ...
    try {
      ...
      final compressedPath = await _compressImage(rawImage.path);
      ...
      if (multipleDetected) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => MultiInjuryScreen(imagePath: compressedPath),
          ),
        );
      } else {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                AssessmentResultScreen(imagePath: compressedPath),
          ),
        );
      }
    } catch (e) {
  ...
  Future<String> _compressImage(String originalPath) async {
    try {
      ...
      final compressedFile = File('${originalPath}_compressed.jpg');
